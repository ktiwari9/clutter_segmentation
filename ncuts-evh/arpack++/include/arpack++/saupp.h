...
inline void saupp(ARint& ido, char bmat, ARint n, const char* which, ARint nev,
...

{
  ...
  F77NAME(dsaupd)(&ido, &bmat, &n, const_cast<char*>(which), &nev, &tol, resid, &ncv,
...

{
  ...
  F77NAME(ssaupd)(&ido, &bmat, &n, const_cast<char*>(which), &nev, &tol, resid, &ncv,
                  &V[1], &ldv, &iparam[1], &ipntr[1], &workd[1], &workl[1],
                  &lworkl, &info);
