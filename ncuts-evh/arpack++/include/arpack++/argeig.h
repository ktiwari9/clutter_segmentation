...
class ARGenEig:
  ...
  virtual public ARStdEig<ARFLOAT, ARTYPE, ARFOP> {
	  ...
	  typedef ARrcGenEig<ARFLOAT, ARTYPE> genSuperT;
	  typedef ARStdEig<ARFLOAT, ARTYPE, ARFOP> stdSuperT;
  ...
  while (!genSuperT::BasisOK) {
    ...
    case -1:
      ...
      if (genSuperT::mode != 2) {
        ...
        (objB->*MultBx)(&genSuperT::workd[genSuperT::ipntr[1]],&genSuperT::workd[genSuperT::ipntr[3]]);
      }
    ...
    case  1:
      ...
      if (genSuperT::mode == 2) { // w = x if mode = 2.
        (stdSuperT::objOP->*stdSuperT::MultOPx)(&genSuperT::workd[genSuperT::ipntr[1]],&genSuperT::workd[genSuperT::ipntr[2]]);
      }
      else {           // w = B*x otherwise.
        (stdSuperT::objOP->*stdSuperT::MultOPx)(&genSuperT::workd[genSuperT::ipntr[3]],&genSuperT::workd[genSuperT::ipntr[2]]);
      }
      break;
    ...
    case  2:
      ...
      (objB->*MultBx)(&genSuperT::workd[genSuperT::ipntr[1]],&genSuperT::workd[genSuperT::ipntr[2]]);
