...
int main()
{
    ...
    // Trying out probabilistc decision function with pegasos
...
//    learned_pfunct.normalizer = normalizer;
    learned_pfunct.function = train_probabilistic_decision_function(verbose_batch_cached(trainer,0.1), samples, labels, 3);
    
    sample(0) = 3.123;
    sample(1) = 4;
    cout << "This +1 class example should have high probability.  Its probability is:  " << learned_pfunct(sample) << endl;

    sample(0) = 13.123;
    sample(1) = 9.3545;
    cout << "This -1 class example should have low probability.  Its probability is:  " << learned_pfunct(sample) << endl;
