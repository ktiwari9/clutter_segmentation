...
/*
    ...
    trainer_pegasos.set_max_num_sv(10);

    trainer_multi.set_trainer(trainer_pegasos);
    one_vs_one_decision_function<ovo_trainer> df_multi = trainer_multi.train(samples, labels);
    cout << "predicted label: "<< df_multi(samples[0])  << ", true label: "<< labels[0] << endl;
    cout << "predicted label: "<< df_multi(samples[90]) << ", true label: "<< labels[90] << endl;
*/
