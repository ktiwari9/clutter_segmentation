...
import roslib; roslib.load_manifest('action_manager_pr2')
import rospy
from action_manager_pr2.srv import *
...
class LatestJointStates:
    ...
    def return_joint_state(self, joint_name):
        ...
        #no messages yet
        if self.name == []:
            rospy.logerr("action_manager::joint_state_listener_server: No robot_state messages received!\n")
            return (0, 0., 0., 0.)
        ...
        #unless it's not found
            ...
            rospy.logerr("action_manager::joint_state_listener_server: Joint %s not found!", (joint_name,))
            self.lock.release()
            return (0, 0., 0., 0.)
        self.lock.release()
...
if __name__ == "__main__":
    ...
    print "action_manager::joint_state_listener_server: joints_states_listener server started, waiting for queries"
    rospy.spin()
